...
These dimension utilities may use arbitrary values when precise sizing is required:
...
All other utilities (colors, spacing, font sizes, border radius, margins, padding, gaps, etc.) must use design tokens defined in `@theme`.
